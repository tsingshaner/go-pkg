module github.com/tsingshaner/go-pkg/errors

go 1.22

require (
	github.com/stretchr/testify v1.9.0
	github.com/tsingshaner/go-pkg/conf v0.0.2
	github.com/tsingshaner/go-pkg/log v0.3.0
...
require (
	...
	github.com/tsingshaner/go-pkg/util v0.3.0 // indirect
